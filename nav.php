...
<nav class="navbar">
    <ul class="navbar-nav">
      <li class="logo">
        <a class="nav-link">
          <span class="fonterpg link-text logo-text">RPG</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li class="nav-item">
        <a href="raca.php" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
          ...
          <span class="link-text">Raças</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          ...
          <span class="link-text">Inimigos</span>
        </a>
      </li>
